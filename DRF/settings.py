...
if DEBUG==False:
    ...
    'default': {
        ...
        'NAME': os.getenv('DB_NAME_PROD'),  #recruit_info
        'USER': os.getenv('DB_USER_PROD'),  # os.environ.get('DJANGO_MYSQL_USER')
        'PASSWORD': os.getenv('DB_PASSWORD_PROD'),  # os.environ.get('DJANGO_MYSQL_PASSWORD')
        'HOST': os.getenv('DB_HOST_PROD'),  # os.environ.get('DJANGO_MYSQL_HOST')
    ...
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.getenv('DB_NAME_DEV'),  #recruit_info
        'USER': os.getenv('DB_USER_DEV'),  # os.environ.get('DJANGO_MYSQL_USER')
        'PASSWORD': os.getenv('DB_PASSWORD_DEV'),  # os.environ.get('DJANGO_MYSQL_PASSWORD')
        'HOST': os.getenv('DB_HOST_DEV'),  # os.environ.get('DJANGO_MYSQL_HOST')
...
SIMPLE_JWT = {
    ...
    'TOKEN_REFRESH_LIFETIME': datetime.timedelta(days=100),  # 设置刷新令牌有效期
}
...
MONGODB_PSW = os.getenv('MONGODB_PSW')
MONGODB_AUTHSOURCE = os.getenv('MONGODB_AUTHSOURCE')
